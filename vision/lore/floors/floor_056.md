...
a numberless seabird-rookery — a wall of guano-white stone that roars with
wing and cry, hazed with drifting down, streaked with droppings, and stinking
...
- **Ground & water plants:** cliff-samphire on the ledges, guano-lichen (rich
  and green), and the salt-thrift clinging to the cranny-lips.
- **Under the Yoke:** the salt-thrift crumbles its hold; the guano-lichen is
...
guano-cutters who work the ledges on rope and read the flocks' mood by their
cries. They shelter in Rookwall on the broad lower ledges, gathering by the
old calls. They love a full egg-basket, a calm cliff, and a rope that holds.
They fear the mobbing flocks and the matron-harpies at the top.
**The keeper:** Cole Rookwall, rookery-keeper — keeps the rookery-lore and the
calming-calls, and climbs the highest ledges no one else will.

## The six
1. **Rookery-matron harpy** (N) — *was:* a great nesting sea-raptor. *now:*
   fever-drawn half-human, shrieking, driving the mobs at climbers. *Cured,
   it folds to a plain sea-eagle and settles on its nest.*
2. **Rook marten** (N) — *was:* an egg-raiding marten. *now:* bold and
   climbing, dropping onto ledge-walkers from above. *Cured, it flows into a
   cranny.*
3. **Fledgling mob** (N) — *was:* the rookery's young. *now:* a screaming
   tide of half-grown birds that swarm and buffet a climber off the wall.
   *Cured, the mob scatters back to its ledges.*
4. **Rookery drake** (N) — *was:* a cliff-roosting drake. *now:* nesting the
   high cranny, bursting out to strafe the ledges. *Cured, it glides off over
   the sea.*
5. **Cliff-crab** (N) — *was:* a ledge-scavenging crab. *now:* big and bold,
   shearing at fingers gripping the holds. *Cured, it sidles into a crevice.*
6. **Egg-wight** (W) — *was:* a climber who fell from the ledges, aether in
   his cut rope. *now:* a down-clotted figure that walks the ledges cutting
