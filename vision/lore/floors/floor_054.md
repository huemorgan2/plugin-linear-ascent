...
hulls broken open and half-buried, masts snapped, lift-cells burst, keels
upturned like whale-ribs across the grass. The ships fell the night the sky
...
- **Trees / canopy:** none but the wrecks' own snapped masts standing like
  dead trees.
- **Ground & water plants:** hull-moss on the broken timbers, rigging-vine
  climbing the masts, and the lift-lichen that fruits on burst aether-cells.
- **Under the Yoke:** the rigging-vine snares like living rope; the lift-
...
figurehead and which holds still hold air, and dives the deepest hulls alone.

## The six
1. **Salvage harpy** (N) — *was:* a rigging-scavenger raptor. *now:* fever-
   drawn half-human, shrieking, tearing at climbers on the masts. *Cured, it
   folds to a plain kite and wheels off.*
2. **Hold-nesting drake** (N) — *was:* a hull-roosting drake. *now:* nesting
   in the flagship holds, bursting out to strafe. *Cured, it glides off over
   the field.*
3. **Hull borer** (N) — *was:* a timber-boring grub grown on the wrecks.
   *now:* dog-sized, tunneling the hulls and collapsing decks. *Cured, it
   burrows into a rotten spar.*
4. **Rigging-rat** (N) — *was:* a ship's rat. *now:* running the shroud-lines
   in packs, gnawing the rigging. *Cured, it scurries up a mast.*
5. **Spar-crab** (N) — *was:* a hull-cleaning crab. *now:* timber-shelled,
   clinging to the keels and shearing at climbers. *Cured, it sidles into a
   hull-gap.*
6. **Wreck-crew** (W) — *was:* a ship's crew who died in the crash, aether
   caught in the dead hull. *now:* a rope-tangled deck-gang that works a
