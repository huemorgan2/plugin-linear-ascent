# Floor 13 — The Eaves (Elves)

> *"We lived at the edge of the wood so we'd hear trouble coming. Now the wood is the trouble, and it whispers." — Nael Edgewatch*
...
- **Trees / canopy:** eave-oak and thin lamp-birch, their sap dim, laced with
  the copper filament of the old signal-lines.
...
border to warn the deep glades. Now cut off from those glades entirely, they
keep a lonely watch over marsh and mine, listening to their own dead network
loop. They love a clear watch, a carried message, and the deep wood they can
no longer reach. They fear the whispering moss and the shades in the gloom.
**The keeper:** Nael Edgewatch, border-warden — keeps the last watch-fire and
strains to hear a true signal in the dead hum.

## The six
1. **Gloom hound** (N) — *was:* an elf-bred tracking hound. *now:* grey-eyed
   and silent, hunting by the dead signal's pulse. *Cured, it whines and
   comes to a hand.*
2. **Dusk boar** (N) — *was:* a twilight-rooting boar. *now:* gloom-black,
   charging from the fern at any warmth. *Cured, it snorts and ambles off.*
3. **Edge-stag** (N) — *was:* a border-grazing stag. *now:* antlers fouled in
   dead signal-wire, goring at the hum. *Cured, it sheds the wire and steps
   into the trees.*
4. **Dusk-moth** (N) — *was:* a border pollinator. *now:* grey and swarming,
   drawn to the copper filament and any spark. *Cured, it drifts to the
   ferns.*
5. **Dead signal** (W) — *was:* nothing — aether looping in a broken lamp-
   line. *now:* a stuttering voice-shape that repeats an old warning and
   walks the moss toward listeners. *Broken, the loop closes and it drains
   down the filament.*
6. **Eaves shade** (W) — *was:* an edge-warden lost on watch, aether in the
