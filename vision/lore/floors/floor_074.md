# Floor 74 — The Snare Woods (Elves)
...
set fine snares for game, now seeded root to crown with wire, tripline,
deadfall, and beetle-tick, the fever multiplying every snare a thousandfold.
...
- **Trees / canopy:** snare-elm and springpole-ash, their boughs cocked with
  natural traps, hung with wire-vine.
- **Ground & water plants:** tripwire-bramble, noose-creeper, and the pale
  bait-flower a snare grows over itself as a lure.
- **Under the Yoke:** the noose-creeper tightens like a set snare; the
...
who read a wood for what it hides. Now their own wood is one great snare, and
they shelter in Brambleside on the few cleared paths, disarming what they can.
They love a clean-set snare, a slipped trap, and a path proven safe. They fear
the wire-seeded ground and the caught things still hanging in it.
**The keeper:** Illa Brambleside, snare-warden — keeps the snare-lore and
disarms the master-traps, and reads a cocked wood by the tension in the air.

## The six
1. **Funnel hound** (N) — *was:* a snare-driving hound. *now:* coursing to
   herd climbers onto the tripwires and into the nooses. *Cured, it heels off
   the trap-lines to a hand.*
2. **Wire beetle** (N) — *was:* a wire-gnawing beetle. *now:* dog-sized,
   trailing living snare-wire it strings between the trees. *Cured, it drops
   its wire and burrows off.*
3. **Snare-hare** (N) — *was:* the wood's quarry-hare. *now:* bolting to
   spring the traps under a pursuer's feet. *Cured, it slips a noose and is
   gone.*
4. **Tripwire-adder** (N) — *was:* a leaf-litter adder. *now:* strung taut
   across the paths like a living wire, striking at a snagged ankle. *Cured,
   it uncoils into the bramble.*
5. **The caught thing** (W) — *was:* a hunter who died in his own sprung
   snare, aether in the wire that took him. *now:* a wire-tangled figure that
   walks the wood setting and springing snares on the living. *Broken, it
   hangs slack in a noose and drains into the ground.*
6. **Snare-setter** (W) — *was:* a snare-warden lost resetting the master-
   traps, aether in the cocked springpoles. *now:* a grey figure that re-cocks
