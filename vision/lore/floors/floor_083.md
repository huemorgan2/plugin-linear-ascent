# Floor 83 — The Furnace Roads (Made)

> *"The roads run on gratings over the furnaces, so the whole floor's a griddle. Fall through a grate and you're fuel. Stay on the grate and you're a target for the swifts. Choose fast." — Road-crew boss Grint Stokegate*
...
- **Ground growth:** grate-lichen on the cooler bars, cinder-moss in the
...
and reads which gratings are about to give by their glow.

## The six
1. **Cinder swift** (N) — *was:* a furnace-updraft swift. *now:* fire-fast,
   strafing the gratings, snuffing lamps with its wings. *Cured, it darts off
   up a flue.*
2. **Road rat** (N) — *was:* a grate-scavenging rat. *now:* heat-hardened,
   massing in the ash-traps. *Cured, it bolts into the under-grate.*
3. **Grate-moth** (N) — *was:* a furnace moth. *now:* fireproof, swarming the
   glowing bars. *Cured, it drifts off, singed.*
4. **Stoker imp** (P) — *was:* a captured soul forged into a fuel-hauling
   drudge, collar-bound to the roads. *now:* a coal-fisted imp that flings
   burning slag. *Pressed — Break-collar frees it; else a real death.*
5. **Road-warden knight** (P) — *was:* a captured soul welded into heat-plate,
   collared to patrol the gratings. *now:* a glowing knight that fights on the
   grate-edges. *Pressed — the collar breaks; freed, a fire-proof fighter for
   the rising.*
6. **Under-grate thing** (W) — *was:* road-crews who fell through the gratings
   and burned, aether caught in the fused ash. *now:* a slag-and-bone shape
