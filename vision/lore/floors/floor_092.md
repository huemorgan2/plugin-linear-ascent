# Floor 92 — The Mirror Galleries (Made)

> *"The King collects faces. He keeps them here, in the mirrors. Walk the galleries and you'll see people you knew — wearing their stolen faces, not their own. Don't answer to yours if you hear it called." — Sheenrest captive Illa*
...
stolen faces to the blank one mirror at a time.

## The six
1. **Mirror-rat** (N) — *was:* a gallery rat. *now:* silver-matted, nesting in
   the frames. *Cured, it bolts into a gutter.*
2. **Glass-moth** (N) — *was:* a lamp-moth. *now:* swarming its own thousand
   reflections. *Cured, it drifts off.*
3. **Sconce imp** (P) — *was:* a captured soul collared to trim the mirror-
   lamps. *now:* a taper-fisted imp that blinds with lamp-glare. *Pressed —
   Break-collar frees it.*
4. **Gallery duelist** (W) — *was:* a courtier who died fencing his own
   reflection, aether in the glass. *now:* a figure that steps from a mirror
   to duel with a stolen face and skill. *Broken, it shatters back into the
   frame.*
5. **Orphaned reflection** (W) — *was:* a reflection whose owner died, aether
   left masterless in the glass. *now:* a faceless shape that reaches from the
   mirrors to steal a passing face. *Broken, the mirror goes blank and it
   drains away.*
6. **Whispering courtier** (W) — *was:* a courtier lost among the faces,
   aether in the borrowed likeness. *now:* a many-faced figure that calls a
...
welded into one, wearing them in shifting layers, the silvered back of every
mirror in the galleries. A construct of the Making, it fights by stealing a
