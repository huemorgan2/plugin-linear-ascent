# Floor 24 — The Broodwarrens (Deep)

> *"Silkstead was a town once. Then the spiders stopped keeping to the corners." — Wend Silkstead*
...
spiders' patience.
**The keeper:** Wend Silkstead, town-warden — leads the vault's survivors,
and keeps a knife for silk and a lamp for the dark.

## The six
1. **Broodling swarm** (N) — *was:* the warren's spiderlings. *now:* a
   dog-high tide of them flowing along the web-lanes. *Cured, the tide
   scatters up the silk and is gone.*
2. **Warren bat** (N) — *was:* a cavern roost-bat. *now:* silk-fouled and
   frantic, blundering into faces. *Cured, it wings up into a clear vault.*
3. **Brood-midwife spider** (N) — *was:* the sac-tenders. *now:* huge and
   patient, wrapping the living for the nursery. *Cured, it returns to
   tending eggs and ignores the passing lamp.*
4. **Silk-tick** (N) — *was:* a web-parasite. *now:* fist-sized, dropping to
   burrow and bleed. *Cured, it drops off and scuttles into the moss.*
5. **Warren troll** (N) — *was:* a Deep troll that denned in the warm
   caverns. *now:* silk-matted, dragging a bludgeon of fused cocoon.
   *Cured, the slow giant sheds its silk and lumbers off into the dark.*
6. **Cradle-husk** (W) — *was:* a townsperson long wrapped, aether pooled in
   the cocoon. *now:* a silk-bound shape that cries in a child's voice to
