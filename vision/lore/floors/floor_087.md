# Floor 87 — The Siege Gardens (Made)

> *"They grow the siege-engines like the elves grew orchards. Iron seed in an iron bed, and up comes a ram, a tower, a thing with arms. The gardeners are us, pruning-torch in hand, forced to raise the weapons that'll break the next city." — Garden-thrall Nael Ramside*
...
which beds can be soured before they fruit into war.

## The six
1. **Carrion kite** (N) — *was:* a garden scavenger. *now:* roosting the
   trellises, mobbing the gangs. *Cured, it wheels off the girders.*
2. **Garden-rat** (N) — *was:* a seed-bed rat. *now:* iron-toothed, gnawing
   the seed-vault. *Cured, it bolts into a bed.*
3. **Pruning-torch imp** (P) — *was:* a captured soul collared to tend and
   burn the beds. *now:* a torch-fisted imp that sets the oil-lilies ablaze.
   *Pressed — Break-collar frees it; else a real death.*
4. **Iron-thorn creeper** (W) — *was:* grown hedge given a cruel will, aether
   in the cabled thorn. *now:* a grasping wall of engine-vine that shears and
   hauls. *Broken, it falls to dead cable.*
5. **Garden scarecrow** (W) — *was:* a thrall grafted into the beds as a
   ward-effigy, aether in the mounted bones. *now:* a girder-and-bone figure
   that walks the rows herding the living into the iron-thorn. *Broken, it
   falls apart and the grafted dead are freed.*
6. **Unripe engine** (W) — *was:* a half-grown siege-engine quickened wrong,
...
garden's root-cables, dragging whole beds with it, hung with the bones of
