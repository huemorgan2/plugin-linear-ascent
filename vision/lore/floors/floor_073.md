# Floor 73 — The Wind Walls (Giants)
...
across the high passes to break the killing gales, pierced with great shutters
they could open or close to let the wind through by measure. The shutters are
...
- **Trees / canopy:** none — ice ramparts and iron shutters; wind-flattened
  scrub in the wall-shadows.
- **Ground & water plants:** rampart-lichen scoured into the ice, shutter-moss
  in the wind-shadows, and the pale gale-flower that only grows where the
  wind can't reach.
- **Under the Yoke:** the shutter-moss peels loose to fling as debris; the
...
worked the wind-walls, braced strong folk who lean into a gale by instinct.
They shelter in Shuttergate's casemates, working to free the jammed shutters.
They love a broken gale, a worked shutter, and a wind tamed to measure. They
fear the screaming gaps and the wall-wights torn loose in the wind.
**The keeper:** Bruna Shuttergate, wall-warden — keeps the shutter-lore and the
master crank, and reads the wind's force by the note it makes in the walls.

## The six
1. **Gale kite** (N) — *was:* a wall-roosting kite. *now:* riding the shutter-
   gaps, flinging debris and diving at climbers on the ramparts. *Cured, it
   glides off down a wind-shadow.*
2. **Gale-running wolf** (N) — *was:* a pass wolf. *now:* using the gale's
   push to course the ramparts, herding climbers toward the gaps. *Cured, it
...
5. **Wall-boar** (N) — *was:* a wind-shadow boar. *now:* charging the narrow
   ...
   casemate.*
6. **Wall-wight** (W) — *was:* a shutter-crew torn off the ramparts by a
   gale, aether in the jammed shutter that killed them. *now:* a wind-shredded
