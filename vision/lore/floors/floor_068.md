...
under-realm's spider-partners wound and stored the world's finest thread and
...
shelvers, and preservers, meticulous quiet folk who trust a well-wound bundle.
They shelter in Spoolgate among the cold aisles, cutting free the newly wrapped
and guarding the true treasures. They love a neat shelf, a fine-wound reel, and
a treasure kept safe. They fear the stirring bundles and the vault-keeper
spiders' patience.
**The keeper:** Wend Spoolgate, spool-master — keeps the vault-index and a
sharp blade, and knows which bundles hold treasure and which hold someone
still breathing.

## The six
1. **Vault rat** (N) — *was:* a store-room rat. *now:* silk-matted, gnawing
   the bundles and nesting in the shelves. *Cured, it bolts down an aisle.*
2. **Silk-moth** (N) — *was:* a thread-feeding moth. *now:* pale and swarming,
   fouling the reels and blinding the crews. *Cured, it settles on a cold
   bundle.*
3. **Spool-tick** (N) — *was:* a reel-parasite. *now:* clustered on the
   thread, dropping to burrow. *Cured, it drops off into the spool-moss.*
4. **Vault-keeper spider** (N) — *was:* the vaults' partner-spiders. *now:*
   wrapping the living for "storage," neat and patient. *Cured, it returns to
   winding thread and shelving bundles, ignoring the passing lamp.*
5. **Vault-breaker troll** (N) — *was:* a Deep troll that raided the stores.
   *now:* fever-greedy, tearing shelves down to get at the bundles. *Cured,
   the slow giant sets a shelf right and lumbers off.*
6. **Fresh bundle** (W) — *was:* someone newly wrapped and dead in the vault,
   aether pooled in the cocoon. *now:* a white-wound figure that walks the
