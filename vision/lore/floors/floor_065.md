...
the Theft and settled upright, hull-deep in the mountain's flank, so their
masts stand in ranks like a steel-and-timber forest hung with a canopy of
shroud-lines, ratlines, and rotting sail. The "ground" is the tangle of fallen
...
- **Trees / canopy:** the masts and their rigging themselves — spar, shroud,
  and grey sail in place of branch and leaf.
...
menders who live aloft in the crowsnests and cross the forest hand-over-line.
They shelter in Sparside high in the canopy, never trusting the wreck-choked
floor. They love a taut shroud, a mended sail, and a clean run through the
rigging. They fear the harpies in the lines and the drowned topmen in the
tangle.
**The keeper:** Weld Sparside, mast-warden — keeps the rigging-lore and the
flagship's charts, and knows every safe line through the forest by feel.

## The six
1. **Shroud-runner harpy** (N) — *was:* a rigging-roosting raptor. *now:*
   fever-drawn half-human, running the shroud-lines, cutting them behind
   climbers. *Cured, it folds to a plain gull and wheels off.*
2. **Crowsnest drake** (N) — *was:* a mast-top drake. *now:* nesting the high
   crosstrees, stooping down the mast-lanes. *Cured, it glides off over the
   canopy.*
3. **Shroud crab** (N) — *was:* a rigging-cleaning crab. *now:* clinging to
   the lines, shearing at hands on the shrouds. *Cured, it sidles into a
   block.*
4. **Mast-rat** (N) — *was:* a ship's rat. *now:* running the ratlines in
   packs, gnawing the rigging. *Cured, it scurries up a mast.*
5. **Spar-owl** (N) — *was:* a mast-roosting owl. *now:* silent and white,
   stooping through the shroud-canopy. *Cured, it wings up to a crosstree.*
6. **Tangled topman** (W) — *was:* a sailor who died fouled in the rigging,
   aether in the ropes that held him. *now:* a rope-shrouded figure that
