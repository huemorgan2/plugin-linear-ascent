# Floor 15 — The Cable Roots (Deep)

> *"The mountain grew roots of copper down here. Something taught them to bite." — Fend Wiregate*
...
## The six
1. **Wire-weaver spider** (N) — *was:* a cable-spinning cave-spider. *now:*
   weaving live wire into shock-webs across the lanes. *Cured, it reels up
   its line and hides.*
2. **Cable-eel** (N) — *was:* a charge-basking deep eel. *now:* swimming the
   flooded conduits, discharging on contact. *Cured, it sinks into a dead
   line.*
3. **Static-bat** (N) — *was:* a roost-bat of the tangle. *now:* fur crackling,
   diving to earth its charge on a warm target. *Cured, it flits into the
   dark.*
4. **Copper-vole** (N) — *was:* a wire-gnawing vole. *now:* metal-toothed,
   stripping live cable and shorting the lanes. *Cured, it burrows off.*
5. **Cable troll** (N) — *was:* a Deep-dwelling troll that nested in the warm
   lines. *now:* wrapped in live cable like armor, swinging a torn bundle
   that arcs where it strikes. *Cured, the great slow creature drops the
   wire and lumbers into a side-cavern.*
6. **Charge-wisp** (W) — *was:* nothing — aether loose in a shorted junction.
