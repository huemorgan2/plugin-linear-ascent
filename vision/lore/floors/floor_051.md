# Floor 51 — The Hanging City (Deep)
...
spider-silk — the Deep-folk's greatest work, a web-borne town of hanging
houses, silk-cable streets, and gossamer plazas that sway over a drop with no
...
the hanging city, sure-footed on silk and easy over the void, web-wrights and
cable-walkers. Now they cling to the steadier platforms as the drifting
spiders cut their streets. They love a taut cable, a steady platform, and a
lamp lit over the deep. They fear the balloon-spiders and the long fall.
**The keeper:** Fenn Skeinside, city-warden — keeps the master anchor and
walks the cables checking every splice, one hand always on a line.

## The six
1. **Balloon-drifting spider** (N) — *was:* a city-spinner spider. *now:*
   ballooning across the chasm on silk-sails, cutting cables and dropping
   citizens. *Cured, it reels in its sail and anchors to a wall.*
2. **Chasm bat** (N) — *was:* a void-roosting bat. *now:* massing off the
   platforms, blundering into cable-walkers. *Cured, it wings off into the
   dark.*
3. **Skein-rat** (N) — *was:* a cable-running rat. *now:* gnawing the silk-
   lines and nesting in the platforms. *Cured, it scurries off along a
   cable.*
4. **Silk-hawk** (N) — *was:* a chasm-hunting hawk. *now:* stooping between
   the bridges, knocking walkers off the lines. *Cured, it wheels off over
   the void.*
5. **Chasm troll** (N) — *was:* a Deep troll that denned on a chasm-ledge.
   *now:* silk-wrapped, hauling on the cables to whip the bridges. *Cured,
   the slow giant clambers off down the wall.*
6. **Citizen husk** (W) — *was:* a city-dweller wrapped and dropped, aether in
   the cocoon. *now:* a silk-bound figure that walks the cables cutting lines
