# Floor 59 — The Trapdoor Fields (Deep)
...
- **Ground & water plants:** dust-lichen (grey on grey, hiding the seams),
...
and long poles, patient careful folk who never trust flat ground. They shelter
in Latchlight on the Watch-Mound, re-marking the safe lines as the spiders
move their lids. They love a proven line, a sprung trap avoided, and firm
ground underfoot. They fear the hidden lids and the things that wait beneath
them.
**The keeper:** Wend Latchlight, field-delver — keeps the lid-maps and probes
every step, and has the scars to prove which steps she got wrong.

## The six
1. **Trapdoor spider** (N) — *was:* a burrow-spider of the plain. *now:*
   dog-to-ogre-sized, exploding up from a lid to drag prey down. *Cured, it
   pulls its lid shut and waits, harmless, below.*
2. **Dust moth** (N) — *was:* a dust-feeding moth. *now:* clouding grey to
   blind and to mask the lid-seams. *Cured, the cloud settles to the floor.*
3. **Pit-adder** (N) — *was:* a funnel-dwelling adder. *now:* lurking the
   dust-funnels, striking as a walker slides. *Cured, it pours down a
   funnel.*
4. **Dust-hound** (N) — *was:* a plain-coursing Deep-dog. *now:* grey-caked,
   driving prey across the lids toward the burrows. *Cured, it pads to the
   mound and heels.*
5. **Field-wise troll** (N) — *was:* a Deep troll that learned the safe
   lines. *now:* fever-cunning, herding climbers off the true path onto the
   lids. *Cured, the slow giant lumbers off along a line it still remembers.*
6. **Sprung trap** (W) — *was:* a delver dragged down and dead in a burrow,
   aether caught in the lid that took him. *now:* a dust-shrouded figure that
