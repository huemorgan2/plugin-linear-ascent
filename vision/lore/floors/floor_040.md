# Floor 40 — The Broodthrone (Deep) · Warden

> *"She doesn't kill you. That's the horror of it. She keeps you — wrapped, alive, and dancing on her threads at her court forever." — Thread-cutter Wend Threadneedle*

**Cut from:** the shared under-caverns — the Deep, raised into a tribute-court by a spider-matriarch · **Gate-town:** Threadneedle · **Warden:** **Matriarch Vyx**

## The land
A single vast cavern spun into a throne-hall of silk — Vyx's Broodthrone, a
tiered web hung with cocoons like lanterns, each a living captive kept as
courtier, servant, or tribute. The Matriarch rules the Deep's spider-brood
...
- **Trees / canopy:** none — silk-galleries in place of trees, spun floor to
  vault.
- **Ground & water plants:** court-silk sheeting the stone, thread-lichen on
  the anchor-lines, and the pale husk-fungus on emptied cocoons.
- **Under the Yoke:** the court-silk pulls toward the throne; the thread-
...
the web as Vyx's court and larder, puppeted when she wills, themselves when
she doesn't. The few still free hide in the anchor-galleries, cutting cocoons
open one thread at a time. They love a thread cut, a captive freed, and a hand
that moves by its own will. They fear the puppeting and the endless patient
wrapping.
**The keeper:** Wend Threadneedle, thread-cutter — leads the free captives,
and knows which lines are structural and which are leashes.

## The six
1. **Throne-web guard** (N) — *was:* the Deep's giant sentry-spiders. *now:*
   Vyx's welded doorwards, spitting anchor-silk. *Cured, the great spider
   reels up and retreats into the vault.*
2. **Broodguard drone** (N) — *was:* Vyx's warrior-brood. *now:* fever-driven
   swarming soldiers of the web. *Cured, the drones scatter up the galleries.*
3. **Thread-page** (P) — *was:* a webbed child-servant, leashed on a control-
   thread. *now:* compelled to run Vyx's errands and spring her snares. *Cut
   the thread, not the child — freeing the leash is the whole point.*
...
lay control-threads onto every captive in her hall — she fights by puppeting
...
free of the web, ungoverned for the first time in years. They climb as the
host's thread-cutters and freers-of-the-bound, carrying **Unstring**,
websteel, and the queen's antivenin — the folk who cut the tower's strings off
everyone still puppeted on the floors above. The fourth tier is freed.
