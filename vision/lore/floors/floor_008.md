# Floor 8 — The Ashline (Waste)

> *"No crown ever wanted this ground. That's why it's still ours." — Kesh of the Grey Wells*
...
- **Trees / canopy:** none but the ash-thorn, a black leafless scrub that
  survives on dew and dead things.
- **Ground & water plants:** grey saltbush, ember-flower (that blooms only in
  heat-shimmer), and the deep-rooted greywell reeds that mark buried water.
...
**The keeper:** Kesh of the Grey Wells, water-finder — walks the dunes with a
divining-reed and a knife, and trusts neither easily.

## The six
1. **Ash salamander** (N) — *was:* a heat-loving rock salamander. *now:*
   ember-veined, it beds in warm ash and lashes with a scalding tail.
   *Cured, it cools and slides under a stone.*
2. **Ashline jackal** (N) — *was:* a dune scavenger. *now:* pack-bold and
   fever-lean, coursing warmth across the flats. *Cured, the pack breaks and
   lopes off.*
3. **Cinder vulture** (N) — *was:* a carrion bird of the frontier. *now:*
   huge, ash-caked, stooping on anything that slows. *Cured, it wheels up
   and away.*
4. **Dune adder** (N) — *was:* a sand-swimming viper. *now:* fever-fast,
   striking from under the ash at a footfall. *Cured, it pours back into the
   dune.*
...
## The Warden — Cinderhide
A dune ogre — Waste-born, pressed, and then *made worse:* welded into a hide
