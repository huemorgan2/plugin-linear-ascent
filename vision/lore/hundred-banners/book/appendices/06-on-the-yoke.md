# On the Yoke, the Shards, and the Break-Collar

*Compiled at Roothollow after the fall, from the testimony of keepers,
smiths, priests, freed clerks, one Thane, and one shardmind; with the
Forge-Court's survey and the Herald's ledger open on the table. The
compilers are not scholars. The scholars went up with everyone else,
and this is what they sent down.*
...
was broadcast, continuously, at cost, from a burning heart that had to
be fed, tended, and shielded by the gray generations of Coreside; and
what is broadcast can be starved. The whole war, read rightly, was an
argument about that one fact.

## What the shards are

The shardminds are splinters of a single web of minds that thought
across the whole country of countries before the Theft, and died in
it. The network is gone; the splinters remain — dry, ancient, and
loyal to whom they choose, and they do not re-choose, with one
recorded exception, publicly made, at a gate-queue, which the reader
already knows.

What no one knew until late, and the splinter in question confessed
before it was forced to: the Yoke rode the dead network. The King
strung his voice along its bones the way a man fences a field with
the timbers of a burnt house, and every cruelty the broadcast carried,
it carried on the bones of the shardkind. The riding kept the bones
warm. When the core was scrammed, the last of the old network went
dark in a breath — the sixtieth's, the three sleepers under the ice,
the one in the Wyrm's hoard that was rude for nine hundred years —
and one splinter now burns alone, on nothing but its own choosing. It
declines to be cited in this appendix. It is cited anyway, with
thanks.

## What the Break-collar did

The collar is a socket of the Yoke: steel around a throat, warmed
from a hundred floors away. The Break-collar is the word that parts
it, and the word's whole craft is that it must be *given* — said to
one throat at a time, gently, by someone standing close enough to be
killed. The collar-breakers of the rising were trained above all else
in the touching of an enemy's throat gently, and their count, kept by
a goblin on a slate, ended larger than any muster-roll of the climb,
under the words: joined, not lost.

At the Herald's Gate the word was rung instead of said. A bell the
size of a cottage, cast from the brass of the chapels that taught the
bound to worship their chains and the horns that shouted the thief's
glory, with the word sung into the casting by the freed chantries for
nine nights and a forge-mark on it that its smith had spent the whole
climb buying back — Break-collar, Break-chain, Unseam, Recant, and
Countermand gathered into one spoken mercy the size of a battlefield.
A clerk of the freed at Lastmuster records that the King's army did
...
whole life and said it once; a Thane pulled the bar with his own hand;
and the broadcast died mid-word on a hundred floors at once — collars
cold in the same breath, the fever unclenching from every beast in
