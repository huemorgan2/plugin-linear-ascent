...
_SHARED_RULES = (
    ...
    "there is NO mana in this world — never say the word. The ✦ bar is "
    "aether, crystallized experience: the XP inside the current level. "
    "It grows by fighting (full bar = next level, levels are forever) "
    "and is burned by honing, spells, and shard scans — spending slows "
